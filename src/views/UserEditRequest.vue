        ...
        >
          ...
          <div class="flex flex-col justify-center items-center">
            ...
            <div class="flex flex-col items-center">
              <label
                class="mt-4 flex flex-col items-center px-8 py-1 bg-black text-white text-blue rounded-lg shadow-lg tracking-wide border border-blue cursor-pointer"
              >
              ...
              <label
                ...
                class="mt-4 flex flex-col items-center px-8 py-1 bg-black text-white text-blue rounded-lg shadow-lg tracking-wide border border-blue cursor-pointer"
              >
                <a :href="'https://127.0.0.1:8000' + filepath" target="_blank"
                  >View File</a
                >
              </label>
              <button
...
export default {
  ...
  async mounted() {
    ...
    let response = await axios.get(
      "http://127.0.0.1:8000/request/" + requestNo + "/",
      {
        headers: {
  ...
  methods: {
    ...
    updateRequest() {
      ...
      let requestNo = localStorage.getItem("requestNo");
      axios
        .put("http://127.0.0.1:8000/request/" + requestNo + "/", fd, {
          headers: {
            Authorization: "Token " + token,
          },
        })
